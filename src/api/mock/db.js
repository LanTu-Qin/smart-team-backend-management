...
const seedCompetitions = [
  {
    ...
    organizer: '教育部',
    content: '【赛事定位】国家级双创顶级赛事；【含金量】高校普遍认可的双创赛事，在推免与综测中常被参考（具体认定以本校政策为准）；【参赛形式】团体参赛，规模以官方通知为准；【适合方向】科技创新、商业落地；【周期】校赛-省赛-国赛三级；【准备周期】建议 6 个月以上；【核心产出】商业计划书 + 路演；【获奖率】官方未公开统一比例，建议参考历年获奖名单；【建议】尽早组队并锁定指导老师。',
    posterUrl: '',
    hasPoster: true,
  },
  {
  ...
  },
  {
    ...
    content: '【赛事定位】国内规模最大的数学建模赛事；【含金量】高校普遍认可的学科竞赛，在推免与综测中常被参考（具体认定以本校政策为准）；【参赛形式】3 人团体；【适合方向】建模 + 编程 + 写作分工；【周期】每年 9 月；【准备周期】建议 3 个月集训；【核心产出】建模论文；【获奖率】官方未公开统一比例，建议参考历年获奖名单；【建议】提前练手真题与论文排版。',
    posterUrl: '',
    hasPoster: false,
  },
  {
